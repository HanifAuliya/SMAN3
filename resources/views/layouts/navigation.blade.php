    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('dashboard.news.create') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('dashboard.sekolahdata.index') ? 'active' : '' }}"
                        href="{{ route('dashboard.sekolahdata.index') }}">
                        {{ __('Data Sekolah') }}
                    </a>
                </li>
                <li class="nav-item">
