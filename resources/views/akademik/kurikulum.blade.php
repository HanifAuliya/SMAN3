...
@section('title', 'Kurikulum Akademik - SMAN 3 Barabai')
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mt-3 mx-auto">
                <h3 class="text-center mb-4">Kurikulum dan Mata Pelajaran</h3>
                <div class="text-center mb-5">
                    <iframe src="{{ asset('assets/pdf/pembelajaran.pdf') }}" class="w-100 rounded shadow-sm"
