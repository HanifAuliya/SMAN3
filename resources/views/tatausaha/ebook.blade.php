...
@section('title', 'E-book - SMAN 3 Barabai')
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mt-3 mx-auto">
                <h3 class="text-center mb-4">Buku elektronik (e-book)</h3>
                <div class="text-center">
                    <iframe src="https://drive.google.com/embeddedfolderview?id=15NBMBfF3R1flAcZ5--fBaJHeR7xQfG7Y#grid"
                        class="w-100 rounded shadow-sm" style="height: 600px; border: none;">
                    </iframe>
                </div>
