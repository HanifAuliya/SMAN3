...
@section('title', 'SOP - SMAN 3 Barabai')
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mt-3 mx-auto">
                <h3 class="text-center mb-4">Standar Operasional Prosedur</h3>
                <div class="text-center">
                    <iframe src="{{ asset('assets/pdf/sop.pdf') }}" class="w-100 rounded shadow-sm"
